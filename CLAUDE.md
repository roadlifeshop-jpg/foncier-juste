...
- Ne jamais écrire dans `CLAUDE.md` ou `ETAT-PROJET.md` un hash, un compteur ou un état susceptible de devenir faux au prochain commit. Donner la commande qui le lit.
