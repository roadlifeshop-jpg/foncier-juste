...
const REGLES = {
  ...
  'tf-surface-ponderee': {
    ...
    texte: "Articles 324 L à 324 V de l'annexe III au code général des impôts ; barème des équivalences à l'article 324 T",
    source: { nom: "Légifrance — article 324 T de l'annexe III au CGI, barème des équivalences superficielles",
              url: 'https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000037128007' },
    source_secondaire: { nom: 'BOFiP — BOI-IF-TFB-20-10-20-50, détermination de la surface pondérée du local',
                         url: 'https://bofip.impots.gouv.fr/bofip/2373-PGP.html/identifiant%3DBOI-IF-TFB-20-10-20-50-20121210' },
    statut: 'en vigueur',
    applicable: '2018-06-30',
    verifiee: '2026-09-18',
    concerne: "Tout local d'habitation évalué selon la méthode de 1970.",
    exceptions: [
      "Le barème de l'article 324 T fixe les mètres carrés ajoutés : 5 m² par baignoire, 4 m² par receveur de douches, 3 m² par lavabo ou autre appareil sanitaire, 3 m² par WC particulier, 4 m² pour l'eau courante, 2 m² pour l'électricité, 3 m² pour le raccordement à l'égout, et 2 m² de chauffage central par pièce et annexe d'hygiène.",
      "Les correctifs, eux, peuvent jouer dans les DEUX sens : le coefficient d'entretien et celui de situation peuvent abaisser la surface pondérée autant que la relever. Un écart entre surface pondérée et surface mesurée n'est donc pas une anomalie, et son sens n'est pas prévisible.",
      "Nous n'annonçons aucun ordre de grandeur pour cet écart : ni l'article 324 T ni le BOFiP n'en donnent, et il dépend entièrement du nombre d'équipements et des correctifs propres au logement. Vérifié le 18 septembre 2026 dans le texte de l'article et dans la totalité du BOI-IF-TFB-20-10-20-50.",
