...
const REGLES = {
  ...
  'vol-montants': {
    ...
    exceptions: [
      ...
      "Un vol de plus de 3 500 km peut rester intracommunautaire — par exemple entre la métropole et un département d'outre-mer : le montant est alors de 400 €, pas de 600 €.",
