...
const CONFIANCE_SURFACE = {
  ...
  acte: {
    niveau: 'moyenne',
    texte: 'Modérée — la surface d’un acte de vente (loi Carrez) ne retient pas exactement les mêmes espaces que l’évaluation fiscale. L’écart reste exploitable, mais devra être confirmé par une mesure.',
    origine: 'Un document que vous détenez, dont la définition de surface diffère de celle de l’administration.',
  },
  estimee: {
    niveau: 'faible',
    texte: 'Faible — surface estimée de mémoire. Ce constat ne suffit pas à fonder une réclamation : mesurez avant d’aller plus loin.',
